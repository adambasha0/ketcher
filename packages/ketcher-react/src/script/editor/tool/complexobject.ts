...
class ComplexObjectTool implements Tool {
  ...
  Promise.resolve(res)
    .then((elem) => {
      ...
      editor.update(
        fromImageCreation(
          editor.render.ctab,
          'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTAwIiBoZWlnaHQ9IjEwMCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KICA8Y2lyY2xlIGN4PSI1MCIgY3k9IjUwIiByPSI0MCIgZmlsbD0iIzQ0NzJjNCIgc3Ryb2tlPSIjMzE1MzhmIiBzdHJva2Utd2lkdGg9IjMiIC8+Cjwvc3ZnPgo=',
          pos,
          new Vec2({ x: 1, y: 1, z: 0 }),
          44444,
        ),
      );
      return;
...
export default ComplexObjectTool;
