...
// import ShapesAll from 'src/script/ui/dialog/toolbox/shapesAll/shapesall';
// import { useShapesContext } from 'src/hooks';

class ShapesAllAtomTool implements Tool {
...
function propsDialog(editor, id, pos) {
  editor.update(
    fromAtomAddition(editor.render.ctab, pos, {
      label: localStorage.getItem('shape_name'),
    }),
  );
  // localStorage.setItem("shape_name", '')
...
export default ShapesAllAtomTool;
