...
import SurfaceChemisItemButtonList from '../../../component/form/SurfaceChemisItemButtonList';
import { Dialog } from '../../../views/components';
import classes from './rgroup.module.less';
import { connect } from 'react-redux';
import { rgroupSchema } from '../../../data/schema/struct-schema';

function ComplexObject({ disabledIds, values, formState, type, ...props }) {
  return (
    <Dialog
      title="Surface Chemistry List"
    ...
    >
      <Form schema={rgroupSchema} init={{ values }} {...formState}>
        <Field
          ...
          multiple={type === 'atom'}
          labelPos={false}
          component={SurfaceChemisItemButtonList}
